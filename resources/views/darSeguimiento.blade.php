<a href="#myModal2pedido" data-toggle="modal" id='modalPedido'></a>
        <!-- Modal -->
        <div id="myModal2pedido" class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
