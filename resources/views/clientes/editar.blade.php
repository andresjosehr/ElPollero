...
<button type="button" style="display: none" id="editarCliente_btn" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
    Launch demo modal
</button>
                ...
                <div id="editarCliente">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <label class="display-inline-block custom-control custom-radio">
                                    <input type="radio" name="tipo_cliente" id="tipo_cliente" value="Juridico empresa" class="custom-control-input">
                                    <span class="custom-control-indicator"></span>
                    ...
                    <div class="col-md-12">
                        <div class="form-actions right">
                            <button onclick="updateCliente()" class="btn btn-danger crearCliente_btn">
