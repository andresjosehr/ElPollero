    ...
    <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                ...
                <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Datos de acceso</span></h6>
            </div>
            <div class="card-body collapse in">
                <div class="card-block">
                    <div id="LoginForm">
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" id="email" placeholder="Correo" required>
                        ...
                        <fieldset class="form-group row">
                            ...
                            <div class="col-md-6 col-xs-12 text-xs-center text-md-right"><a href="resetear-contrasena" class="card-link">¿Olvidaste tu contraseña?</a></div>
                        </fieldset>
                        <button onclick="login_ingreso()" class="btn btn-primary btn-lg btn-block btn_login"><i class="icon-unlock2"></i> Ingresar</button>
                        <div align="center">
                            <div class="loading login_loading" style="width: 40px;height: 40px"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="float-sm-left text-xs-center m-0">
                            <a href="registro/" class="card-link">Registrate!</a>
                        </p>
                    </div>
                </div>
            </div>
