    ...
    <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1 box-shadow-2 p-0">
		<div class="card border-grey border-lighten-3 px-2 py-2 m-0">
			<div class="card-header no-border">
				...
				<h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Panel de Registro</span></h6>
			</div>
			<div class="card-body collapse in" id="RegistroAdminForm">	
				<div class="card-block">
					<div class="form-horizontal form-simple">
						...
						<button onclick="RegistroAdmin()" class="btn btn-primary btn-lg btn-block"><i class="icon-unlock2"></i> Registrarme</button>
					</div>
				</div>
			</div>
		</div>
