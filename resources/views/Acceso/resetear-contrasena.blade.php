                ...
                <div class="card-block">
                    <div id="LoginForm">
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" id="email" placeholder="Introduce tu email" required>
                            <div class="form-control-position">
                                <i class="icon-head"></i>
                            </div>
                        </fieldset>
                        <button onclick="resetearPass()" style="margin-top: 10px" class="btn btn-primary btn-lg btn-block reset_btn"><i class="icon-unlock2"></i> Resetear Contraseña</button>
                        <div align="center">
